...
public class ResponsesTestMock {
    ...
    @Test
    public void doesMakeStringToJSONReturnJSONObject() throws IOException, JSONException{
        ...
        assertThat(responseWriter.makeStringToJSON(testResponse), instanceOf(JSONObject.class));
